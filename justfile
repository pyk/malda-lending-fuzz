...
repomix-risc0-crates:
    rm -f repomix-risc0-v2-crates.xml
    npx repomix --remote https://github.com/risc0/risc0-ethereum --remote-branch release-2.2 --include "crates" -o repomix-risc0-v2-crates.xml
